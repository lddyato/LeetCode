...
public class Longest_Uncommon_Subsequence_I {
     ...
     * length(a)=length(b) and a≠b. Example: abc and abd.
     * In this case we can consider any string i.e. abc or abd as a required subsequence, as out of these two strings one string will never be a subsequence of other string.
     * Hence, return length(a) or length(b).
     * length(a)≠length(b). Example abcd and abc.
